...
fun main(args: Array<String>) {
    ...
    driver(DriverParameters(isDebug = true, waitForAllNodesToFinish = true)) {
        val (partyA, partyB) = listOf(
                ...
                startNode(providedName = CordaX500Name("BankPartyA", "London", "GB"), rpcUsers = listOf(user)),
                startNode(providedName = CordaX500Name("InvestorPartyB", "Bangalore", "IN"), rpcUsers = listOf(user))).map { it.getOrThrow() }
